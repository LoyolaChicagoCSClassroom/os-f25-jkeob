...
grub_target_cc_version='x86_64-pc-linux-gnu-gcc (Gentoo 14.3.0 p8) 14.3.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/14/include -I$(top_srcdir)/include -I$(top_builddir)/include'
